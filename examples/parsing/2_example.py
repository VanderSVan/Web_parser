...
from parsing.data_collection import Page, PageParser, PageDataCollector
...
if __name__ == '__main__':
    # data collection
    try:
        for page_number, data in enumerate(hh_search_pages_data.collect_data_from_links(
                page_links=[
                    "https://hh.ru/search/vacancy?area=113&text=python&page=0",
                    "https://hh.ru/search/vacancy?area=113&text=python&page=1",
                    "https://hh.ru/search/vacancy?area=113&text=python&page=2"
                ]
        ), start=1):
